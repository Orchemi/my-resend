...
- **Node.js 20+** - Runtime environment (CI pins `node-version: '20'`)
- **React 19** - UI library
...
- **API key authentication** - Bearer token format: `mrs_keyId_secretPart`
...
npm run typecheck    # tsc --noEmit (0-error baseline enforced by CI)
